      ...
      <section class="resultSection responseResultsSection resultDataSectionV953">
        ...
        <div class="resultDetailsBody">
          <div class="resultTools">
            ...
            <label class="responseAttendanceFilterFieldV1041" for="responseAttendanceFilter"><span>出席狀態</span><select id="responseAttendanceFilter" aria-label="出席狀態" onchange="filterResponseRows()"><option value="">全部狀態</option><option value="attend">可參加</option><option value="cannot">不克參加</option></select></label>
