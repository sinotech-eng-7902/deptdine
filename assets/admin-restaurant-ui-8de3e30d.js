...
(() => {
  ...
  function installRestaurantHistoryModalV1030(){
    ...
    mask.hidden=true;
    mask.innerHTML=`<section class="restaurantHistoryDialogV1030" role="dialog" aria-modal="true" aria-labelledby="restaurantHistoryTitleV1030"><header class="restaurantHistoryHeadV1030"><h2 id="restaurantHistoryTitleV1030">餐廳歷程</h2><div class="restaurantHistoryHeadActionsV1032"><select id="restaurantHistoryActivitySelectV1031" aria-label="查看活動" hidden></select><button class="restaurantHistoryCloseV1030" type="button" aria-label="關閉餐廳歷程">×</button></div></header><nav class="restaurantHistoryTabsV1032" role="tablist" aria-label="餐廳歷程檢視"><button id="restaurantHistoryOverviewTabV1032" type="button" role="tab" aria-controls="restaurantHistoryOverviewViewV1032" aria-selected="true">餐廳總覽</button><button id="restaurantHistoryActivityTabV1032" type="button" role="tab" aria-controls="restaurantHistoryActivityViewV1032" aria-selected="false">活動歷程</button></nav><div id="restaurantHistoryBodyV1030" class="restaurantHistoryBodyV1030"><div class="restaurantHistoryLoadingV1030">正在整理餐廳歷程…</div></div><footer class="restaurantHistoryFootV1030"><button class="btn" type="button">關閉</button></footer></section>`;
