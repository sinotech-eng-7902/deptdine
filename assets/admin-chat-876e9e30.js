...
(function(){
  ...
  function stopConversationListenersV915(){
    ...
    unreadCountAtOpenV924=0;unreadBoundaryMessageIdV924='';positionUnreadOnNextRenderV924=false;
  ...
  function renderMessagesV915(){
    ...
    requestAnimationFrame(()=>{const divider=list.querySelector('.chatUnreadDividerV924');if(positionUnreadOnNextRenderV924&&divider){divider.scrollIntoView({block:'start'});positionUnreadOnNextRenderV924=false}else if(forceScrollToBottomV924||wasNearBottom){list.scrollTop=list.scrollHeight;forceScrollToBottomV924=false;pendingNewMessageCountV925=0}else list.scrollTop=previousTop;if(query)focusSearchMatchV925(0);syncJumpLatestV924()});
  }
  ...
  function subscribeRoomV915(roomId){
    ...
    const acceptMessages=(snapshot,paged=true)=>{
      ...
      if(!unreadBoundaryMessageIdV924&&unreadCountAtOpenV924>0){const boundary=Math.max(0,activeMessagesV915.length-unreadCountAtOpenV924);unreadBoundaryMessageIdV924=activeMessagesV915[boundary]?.id||''}
  ...
  async function openRoomV915(roomId){
    ...
    activeRoomIdV915=roomId;unreadCountAtOpenV924=unreadForRoomV915(room);unreadBoundaryMessageIdV924='';positionUnreadOnNextRenderV924=unreadCountAtOpenV924>0;forceScrollToBottomV924=unreadCountAtOpenV924===0;replyTargetV924=null;selectedMessageIdV924='';chatSearchQueryV924='';visibleMessageLimitV925=50;pendingNewMessageCountV925=0;previousMessageIdsV925=new Set();searchMatchIndexV925=0;olderMessagesV931=[];oldestMessageDocV931=null;hasOlderMessagesV931=true;loadingOlderMessagesV931=false;
