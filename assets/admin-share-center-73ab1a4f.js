...
(function(){
  ...
  function installToolbar(){
    ...
    // v10.27：更多選單原本只有「分享活動」，改為可直接辨識的圖示入口。
    ...
    if(!button){
      ...
      button.setAttribute('data-tooltip','分享活動');
      ...
      button.addEventListener('focus',()=>button.classList.add('isTooltipVisibleV1027'));
      button.addEventListener('blur',()=>button.classList.remove('isTooltipVisibleV1027'));
